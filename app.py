...
Please share your professsional evaluation on whether the candidate's profile aligns with job description
Highlight the strenghts and weakness of applicant in relation to the specified job requirements
"""
...
# Additionally,offer advice on enhancing the candidate's skill and identify 
# """

input_prompt3 = """
You are an skilled ATS (Applicant Tracking System) scanner with a 
deep understanding of any one job role from data science,
